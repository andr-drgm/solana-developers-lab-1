...
use anchor_spl::{
    associated_token::AssociatedToken, token::spl_token::state::Account, token_interface::{transfer_checked, Mint, TokenAccount, TokenInterface, TransferChecked}
};
...
pub fn send_offered_token_to_vault(
    ...
    let transfer_accounts = TransferedChecked {
